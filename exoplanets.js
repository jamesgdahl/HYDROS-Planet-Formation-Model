window.EXOPLANETS = [
  ...
  },
  {
    ...
    "ly": 45.91,
    "inputs": {"M_star": 1.03, "spin": 5.459983, "f_disc": 0.251487},
    "notes": "3 gas giants (f_disc formally unconstrained). d in situ at slot 0 (11.6 AU). b and c are a resonance-locked adjacent-slot pair (slots 3 and 2): their observed spacing is exactly rho (2.1/3.6 = 0.5833 vs rho = 0.5837, 0.07%) at the cascade's natural 2.24:1 capture ratio, and both sit displaced inward from their slots by the same -9% — one rigid pair drift, not independent migrations. The resonance-lock fate caught mid-act. Slot 1 hosted a body whose loss accompanied the pair's slide; its mass (and the merger attribution and PACKED depth that ride on it) is an f-artifact and should not be asserted — empty-slot predictions scale with the unconstrained f while the filled giants fit at any f via t_form.",
    "planets": [
