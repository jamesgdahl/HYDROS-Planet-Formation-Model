...
function classify_slot(slot: ClassifySlotInfo, primordial: Composition,
  ...
  function _classify(core_v: number, ice_v: number, h_he_v: number, total_v: number): string {
    ...
    if (total_v >= M_STELLAR)    return "M-class star";
