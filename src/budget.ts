...
function in_low_spin_fission_window(lambda: number, M_star_msun: number, R_A: number,
                                    _f_rock: number = COMP_F_ROCK): boolean {
...
function corotation_radius(M_star_msun: number, lambda: number): number {
...
function fission_product_radius(M_star_msun: number, lambda: number, R_A: number): number {
  if (!(R_A > 0)) return 0;
...
function in_fission_window(M_star_msun: number, lambda: number, R_A: number): boolean {
...
function fission_lift_fraction(M_star: number, lambda: number): number {
...
function fission_concentrated_mass(M_star: number, lambda: number): number {
...
function silica_vapor_pressure(T_K: number): number {
...
function core_accretion_temperature(M_star: number, lambda: number, Mdot_msun_yr: number): number {
