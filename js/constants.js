...
function set_disc_metals(m) { COMP_DISC_METALS = (m >= 0) ? m : -1.0; }
function reset_disc_metals() { COMP_DISC_METALS = -1.0; }
...
function set_wide_dam(r) { COMP_WIDE_DAM = r; }
function reset_wide_dam() { COMP_WIDE_DAM = -1.0; }
